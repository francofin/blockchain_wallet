...
def calculate_wage(professional, hours):
    wage = hours * candidate_database[professional][3]

    return wage

total_wage = calculate_wage(person, hours)
...
if st.sidebar.button("Send Transaction"):
    transaction_hash = send_transaction(w3, account, candidate_database[person][1], total_wage)
